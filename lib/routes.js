...
module.exports = (app) => {
    ...
    app.post('/wg', (req, res) => {
        ...
        /*
        if (session.userid) {
          console.log('The react app sees that ' + session.userid + ' is now playing the word game.')
        } else {
          console.log('The session object is undefined.')
        }
        */

        // if (req.session) {
        //    // use fs to write updates to some file w/username and game info
        // }
