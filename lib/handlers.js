...
function getWord() {
    ...
    https.get('https://random-word-api.herokuapp.com/word?number=1&swear=0', (resp) => {
      data = '';
...
// const word = require('../lib/wordoftheday.js');

// let wordOfTheDay = word.setWordOfTheDay();
...
exports.handleHomePage = function(req, res) {
  ...
  if (req.session.userid) {
    ...
    res.render('home.hbs', {
      pageTitle:'Home Page',
      welcomeMessage: "The word of the day is " //+ wordOfTheDay + ".",
    });
  }
}
...
exports.handleWordgamePage = function(req, res) {
  ...
  let response = https.get('https://random-word-api.herokuapp.com/word?number=1&swear=0', (resp) => {
      data = '';
